...
public class MetalCubeAnalyzer {
	...
	public void enterCube() {
		...
		System.out.println("Plese enter hight of the cube");
		cube.setHeight(input.inputDouble());
		System.out.println("Plese enter width of the cube");
		cube.setWidth(input.inputDouble());
		System.out.println("Plese enter length of the cube");
	...
	public void printReport() {
		...
		double sum=countGoodCubes+countBadCubes;
		double GoodPercent=countGoodCubes/sum*100;
		double BadPercent=(countBadCubes/sum)*100;
