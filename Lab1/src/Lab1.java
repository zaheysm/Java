 ...
 * @author/Professor: JGeorge Kriger
 * 
  */
public class Lab1 {
	...
	public static void main(String[] args) {
		...
		do {//do while
			try {//try statement
				displayMainMenu();
				int option = Integer.parseInt(Numbers.testEmptyString(scan));//declare option to input option
				switch (option) {//switch statement according to input of the user
					...
					case 2:
						...
						int size = Integer.parseInt(Numbers.testEmptyString(scan));//declare option to input option
